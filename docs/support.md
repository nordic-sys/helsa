...
One person makes Helsa. That is the whole support department, and it is worth knowing before you write.
{: .fs-5 .fw-300 }
...
> **A screenshot is worth more than a description — and it may contain your health data.**
> That is your call, not mine. Crop it, blur it, or describe it in words instead; a report
> without numbers is still useful. Nothing you send is stored anywhere beyond the mailbox, and
> nothing is ever added to the app.
{: .warning }
...
- [**Privacy**](privacy.html) — what leaves your device, which by default is nothing.
- [**Disclaimer**](disclaimer.html) — what Helsa is not, and what it must not be used for.
